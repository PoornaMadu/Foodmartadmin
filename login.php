...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    if (empty($mailid) || empty($password)) {
        ...
        $sql = "SELECT * FROM  admin WHERE email='$mailid' AND password='" . md5($password) . "'";
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <div class="text-danger"><?php echo (isset($_GET['success']) && $_GET['success'] == 'false' ? 'Invalid Email or Password' : '') ?></div>
